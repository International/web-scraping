...
'''
Scrap http://www.ic.gc.ca/eic/site/ccc-rec.nsf/eng/00039.html
Interesting: Selenium middleware, following-sibling::, 
'''

class IndustryCanadaItem(scrapy.Item):
...
class IndustryCanadaSpider(scrapy.Spider):
    #IndustryCanada
